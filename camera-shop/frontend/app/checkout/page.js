  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-lg">
        <h1 className="text-3xl font-bold text-center text-blue-600 mb-8">🧾 Захиалга өгөх</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Утасны дугаар</label>
            <input
              type="text"
              value={phone}
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Хүргүүлэх хаяг</label>
            <textarea
              value={address}
